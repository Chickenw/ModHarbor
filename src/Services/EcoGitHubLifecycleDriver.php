...
class EcoGitHubLifecycleDriver
    extends AbstractGitHubArchiveLifecycleDriver
{
    ...
    public function validatePath(string $path): void
    {
        ...
        if (
            ...
            throw new RuntimeException(
                'GitHub archive attempts to replace an Eco core mod path.'
            );
        }
    }
    ...
    {
        /*
         * Same safety policy as the mod.io Eco integration:
         * runtime/user config survives update/remove.
         */
        return (
            str_starts_with(
                $path,
    ...
    public function prepare(
        ...
        /*
         * Create missing active .eco files from templates, just like the
         * existing mod.io lifecycle driver. Existing configs are untouched.
         */
        foreach (
            $prepared['files']
            as $target => $source
